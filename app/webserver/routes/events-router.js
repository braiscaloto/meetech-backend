...
const getEventsUser = require("../controllers/event/get-events-user-controller");
...
const getUserEvent = require("../controllers/event/get-user-events-controller");
const router = express.Router();

router.get("/eventsuser", checkAccountSession, getEventsUser);
router.get("/events", checkAccountSession, getEvents);
router.get("/allevents", getAllEvents);
router.get("/userevent/:eventId", checkAccountSession, getUserEvent);
